                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" v-model="form.company" @change="getBranch">
                                                <option v-for="company in companies" :key="div" :value="company.id" name="division">{{ company.customer_name }}</option>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" v-model="form.branch" @change="getBranch">
                                                <option v-for="branch in branches" :key="div" :value="branch.id" name="division">{{ branch.branch_name }}</option>
                                            </select>
