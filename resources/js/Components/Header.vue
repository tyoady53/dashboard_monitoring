<template>
    <header class="c-header c-header-light c-header-fixed c-header-with-subheader" :class="[{ hidden: isHidden }]">
        ...
        <ul class="c-header-nav ml-auto mr-4">
            <li class="c-header-nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right pt-0 mb-0 pb-0">
                    ...
                    <Link v-if="permissions.includes('permissions.index')" href="/permission" class="dropdown-item"
                        role="button">
...
export default {
    ...
    methods: {
        ...
        handleScroll() {
            ...
            // Hide if scrolling down & already past first area
            this.isHidden = currentY > this.lastY && currentY > 50;
            this.lastY = currentY;
        },
    }
}
